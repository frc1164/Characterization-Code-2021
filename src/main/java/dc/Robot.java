...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    // create left motor
    WPI_VictorSPX leftMotor = setupWPI_VictorSPX(12, Sides.LEFT, true);
    VictorSPX leftMotorRear = new VictorSPX(13);
    leftMotorRear.follow(leftMotor);

    WPI_VictorSPX rightMotor = setupWPI_VictorSPX(2, Sides.RIGHT, false);
    VictorSPX rightMotorRear = new VictorSPX(3);
    rightMotorRear.follow(rightMotor);
